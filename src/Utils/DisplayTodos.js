...
// DisplayTodos component receives various props for managing tasks and their states
const DisplayTodos = ({
  data,
  setData,
  setEdit,
  ...
  // State for managing the search input and search results
  ...
  // useEffect hook to filter tasks based on the search input
  useEffect(() => {
  ...
  // Function to provide a status message based on the percentage of completed tasks
