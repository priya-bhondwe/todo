...
const Home = () => {
  ...
  return (
    <div className="w-full relative min-h-screen pb-60 bg-gradient-to-r from-black to-red-700">
      <div className="max-w-[1300px] px-3 m-auto">
        <div>
          ...
          {/* Notification for adding a task */}
          {addNotification && (
          ...
          {/* Notification for editing a task */}
          {editNotification && (
            <div className="z-10 px-3 py-2 rounded-md bg-white border-l-[5px] flex items-center gap-2 border-green-600 fixed bottom-8 left-[50%] -translate-x-[50%]">
              <FaCheck className="text-xl text-green-500" />
              <h2 className="max-md:text-xs text-sm text-slate-600 font-semibold">
          ...
          {/* Notification for deleting a task */}
          {deleteNotification && (
            <div className="z-10 px-3 py-2 rounded-md bg-white border-l-[5px] flex items-center gap-2 border-green-600 fixed bottom-8 left-[50%] -translate-x-[50%]">
              <FaCheck className="text-xl text-green-500" />
              <h2 className="max-md:text-xs text-sm text-slate-600 font-semibold">
